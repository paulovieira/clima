...
output += "\">\n        </div>\n\n        <div class=\"form-group\">\n            <label for=\"js-edit-name\">URL (internal)</label>\n            <input style=\"cursor: auto;\" type=\"text\" class=\"form-control\" value=\"";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "webPath"), env.opts.autoescape);
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "name"), env.opts.autoescape);
output += "\" disabled>\n        </div>\n\n        <div class=\"form-group\">\n            <label for=\"js-edit-name\">URL (external)</label>\n            <input style=\"cursor: auto;\" type=\"text\" class=\"form-control\" value=\"";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "publicUri"), env.opts.autoescape);
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "webPath"), env.opts.autoescape);
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "name"), env.opts.autoescape);
...
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["maps/templates/map-menu-add-group-modal.html"] = (function() {function root(env, context, frame, runtime, cb) {
var lineno = null;
var colno = null;
var output = "";
try {
output += "<div class=\"modal-header\">\n    <h4 class=\"modal-title\">Add group</h4>\n</div>\n\n\n<div class=\"modal-body\">\n    <form>\n\n        <div class=\"form-group\">\n            <label for=\"js-add-group-name\">Name for the new group</label>\n            <input type=\"text\" class=\"form-control\" id=\"js-add-group-name\" name=\"add-group-name\" autofocus>\n        </div>\n\n    </form>\n</div>\n\n<div class=\"modal-footer\">\n    <button type=\"button\" class=\"btn btn-primary js-modal-add\">Add</button>\n    <button type=\"button\" class=\"btn btn-default js-modal-cancel\">Cancel</button>\n\n    <div id=\"message-status\" style=\"margin-top: 35px;\"></div>\n    <div id=\"\" style=\"margin-top: 10px;\">\n        <h5 id=\"message-links\"></h5>\n    </div>\n</div>\n";
cb(null, output);
;
} catch (e) {
  cb(runtime.handleError(e, lineno, colno));
...
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["maps/templates/map-menu-sortable.html"] = (function() {function root(env, context, frame, runtime, cb) {
var lineno = null;
var colno = null;
var output = "";
try {
output += "<ul class=\"list-group\" data-items-type=\"map-group\">\n\n    ";
frame = frame.push();
var t_3 = runtime.contextOrFrameLookup(context, frame, "items");
if(t_3) {var t_2 = t_3.length;
for(var t_1=0; t_1 < t_3.length; t_1++) {
...
frame.set("loop.last", t_1 === t_2 - 1);
frame.set("loop.length", t_2);
output += "\n\n    <li class=\"list-group-item map-menu-group\" data-group-name=\"";
output += runtime.suppressValue(runtime.memberLookup((t_4),"groupName", env.opts.autoescape), env.opts.autoescape);
output += "\">\n\n        ";
if(runtime.contextOrFrameLookup(context, frame, "mode") == "groups") {
output += "\n        <i class=\"fa fa-arrows\" style=\"margin-right: 10px; \" data-items-type=\"map-group\"></i>\n        ";
;
}
output += "\n\n        <b>";
output += runtime.suppressValue(runtime.memberLookup((t_4),"groupName", env.opts.autoescape), env.opts.autoescape);
output += "</b>\n\n        ";
if(runtime.memberLookup((t_4),"groupName", env.opts.autoescape) != "not published") {
output += "\n        <i class=\"fa fa-trash\" style=\"cursor: pointer; float: right; margin-right: 6px; color: #990000;\" ></i>\n        ";
;
}
output += "\n\n        <ul class=\"list-group\" style=\"margin-bottom: 15px;\" data-items-type=\"map-item\">\n\n            ";
frame = frame.push();
var t_7 = runtime.memberLookup((t_4),"maps", env.opts.autoescape);
if(t_7) {var t_6 = t_7.length;
for(var t_5=0; t_5 < t_7.length; t_5++) {
var t_8 = t_7[t_5];
frame.set("obj2", t_8);
...
frame.set("loop.last", t_5 === t_6 - 1);
frame.set("loop.length", t_6);
output += "\n\n                <li class=\"list-group-item\" data-map-id=\"";
output += runtime.suppressValue(runtime.memberLookup((t_8),"mapId", env.opts.autoescape), env.opts.autoescape);
output += "\" >\n                    ";
if(runtime.contextOrFrameLookup(context, frame, "mode") == "maps") {
output += "\n                    <i class=\"fa fa-arrows\" style=\"margin-right: 10px;\" data-items-type=\"map-item\"></i>\n                    ";
;
}
output += "\n\n                    ";
output += runtime.suppressValue(runtime.memberLookup((t_8),"mapId", env.opts.autoescape), env.opts.autoescape);
...
var output = "";
try {
output += "\n<div class=\"row\" style=\"margin-top: 20px;\">\n    <div class=\"col-sm-8 col-sm-offset-2 \" style=\"\">\n    \t\n\t\tMode:\n\n\t\t<div class=\"radio\">\n\t\t    <label>\n\t\t        <input type=\"radio\" name=\"menu-order-mode\" value=\"maps\"> \n\t\t        Order maps (move a map to a new position)\n\t\t    </label>\n\t\t</div>\n\n\t\t<div class=\"radio\">\n\t\t    <label>\n\t\t        <input type=\"radio\" name=\"menu-order-mode\" value=\"groups\"> \n\t\t\t\tOrder groups of maps (move a whole group of maps, maintaining the order within the group)\n\t\t    </label>\n\t\t</div>\n\n\n\n    </div>\n</div>\n<div class=\"row\" style=\"margin-top: 0px;\">\n    <div class=\"col-sm-8 col-sm-offset-2 \" style=\"\">\n\n        <button type=\"button\" class=\"btn btn-primary\" id=\"js-menu-add-group\">New group</button>        \n        <div id=\"mn-r-sortable-list\"></div>\n\n\n\n\n\n    </div>\n</div>\n\n\n<div class=\"row\" style=\"margin-top: 40px;\">\n    <div class=\"col-sm-6 col-sm-offset-3\">\n\t\t<button type=\"button\" class=\"btn btn-primary btn-block\" id=\"js-save-map-menu\">Save</button>\n    </div>\n</div>";
cb(null, output);
;
} catch (e) {
  cb(runtime.handleError(e, lineno, colno));
