...
var LegendColorsIV = Mn.ItemView.extend({
	...
	events: {
		"change         input.js-classes-left-extreme": "renderAgain",
		"propertychange input.js-classes-left-extreme": "renderAgain",
		"input          input.js-classes-left-extreme": "renderAgain",

		"change         input.js-classes-right-extreme": "renderAgain",
		"propertychange input.js-classes-right-extreme": "renderAgain",
		"input          input.js-classes-right-extreme": "renderAgain"
	},
	renderAgain: function(e){
...
//debugger;
	...
	onRender: function(){
		...
		this.$('.my-color-picker').colorpicker().on('hidePicker.colorpicker', function(e){
			...
			// var currentColors = self.getInputValues('input.my-color-picker');

			// // update the objects in the "scale" array
			// var scale = self.model.get("scale");

			// if(currentColors.length !== scale.length){
			// 	throw new Error("Unexpected array length");
			// }
			...
			// // destroys the colorpicker plugin and unbind all .colorpicker events
			// self.$('.my-color-picker').colorpicker('destroy');
...
var LegendChooseAttributeLV = Mn.LayoutView.extend({
	...
	behaviors: {
		...
		ShowLegendPreviewModal: {
			...
			modelKey: "aux"  // and using the model referenced in this key
		},
	},
