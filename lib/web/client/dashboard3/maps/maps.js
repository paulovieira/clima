	...
	getAttributeStats: function(){
		...
		Q(promise)
			.then(function(data){ 
				...
				var isInt = /int/.test(data.columnType.toLowerCase());
				self.set("selectedAttributeIsInt", isInt);
				...
				if(isInt){
					...
					self.set("selectedAttributeMin", parseFloat(data.min));
					self.set("selectedAttributeMax", parseFloat(data.max));	
				}
...
//debugger;
		...
		console.log("verify the check for the number of classes <= interval lemgth")
