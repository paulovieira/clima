...
frame = frame.push();
var t_6 = runtime.contextOrFrameLookup(context, frame, "distinctWords");
...
output += "\n                    <li>\n                        ";
if(t_7 == runtime.contextOrFrameLookup(context, frame, "undefined")) {
...
frame = frame.push();
var t_10 = runtime.contextOrFrameLookup(context, frame, "scale");
if(t_10) {var t_9 = t_10.length;
for(var t_8=0; t_8 < t_10.length; t_8++) {
var t_11 = t_10[t_8];
frame.set("class", t_11);
...
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((t_11),"valueClass", env.opts.autoescape)),0, env.opts.autoescape), env.opts.autoescape);
output += "\n\n                        ";
if(runtime.memberLookup((runtime.memberLookup((t_11),"valueClass", env.opts.autoescape)),0, env.opts.autoescape) != runtime.memberLookup((runtime.memberLookup((t_11),"valueClass", env.opts.autoescape)),1, env.opts.autoescape)) {
output += "\n                            &ndash; ";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((t_11),"valueClass", env.opts.autoescape)),1, env.opts.autoescape), env.opts.autoescape);
output += "\n                        ";
;
}
output += "\n\n                    </td>\n\n                    <td class=\"text-center\" style=\"background-color: ";
output += runtime.suppressValue(runtime.memberLookup((t_11),"colorHex", env.opts.autoescape), env.opts.autoescape);
...
output += runtime.suppressValue(env.getFilter("trim").call(context, (lineno = 138, colno = 40, runtime.callWrap(runtime.memberLookup((t_1),"getCartoCode", env.opts.autoescape), "macros[\"getCartoCo\"]", [runtime.contextOrFrameLookup(context, frame, "scale"),runtime.contextOrFrameLookup(context, frame, "tableName"),runtime.contextOrFrameLookup(context, frame, "columnName"),runtime.contextOrFrameLookup(context, frame, "geometryTypePrimitive"),runtime.contextOrFrameLookup(context, frame, "dataType")]))), env.opts.autoescape);
output += "\n                </code></pre>\n            </div>\n\n        </div>\n\n\n        ";
...
output += runtime.suppressValue(env.getFilter("escape").call(context, env.getFilter("trim").call(context, (lineno = 205, colno = 48, runtime.callWrap(runtime.memberLookup((t_1),"getDefaultLegendHtml", env.opts.autoescape), "macros[\"getDefault\"]", [runtime.contextOrFrameLookup(context, frame, "scale"),runtime.contextOrFrameLookup(context, frame, "mapName"),runtime.contextOrFrameLookup(context, frame, "legendStyle")])))), env.opts.autoescape);
output += "\n                </code></pre>\n            </div>\n\n        </div>\n\n\n \n\n        ";
;
}
output += "\n\n    </div>\n</div>\n";
