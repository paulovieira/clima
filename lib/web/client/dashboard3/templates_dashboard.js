...
output += runtime.suppressValue(env.getFilter("trim").call(context, (lineno = 174, colno = 40, runtime.callWrap(runtime.memberLookup((t_1),"getCartoCode", env.opts.autoescape), "macros[\"getCartoCo\"]", [runtime.contextOrFrameLookup(context, frame, "scale"),runtime.contextOrFrameLookup(context, frame, "tableName"),runtime.contextOrFrameLookup(context, frame, "columnName"),runtime.contextOrFrameLookup(context, frame, "geometryTypePrimitive"),runtime.contextOrFrameLookup(context, frame, "dataType")]))), env.opts.autoescape);
output += "\n                </code></pre>\n            </div>\n\n        </div>\n\n\n        ";
...
output += runtime.suppressValue(env.getFilter("escape").call(context, env.getFilter("trim").call(context, (lineno = 259, colno = 48, runtime.callWrap(runtime.memberLookup((t_1),"getDefaultLegendHtml", env.opts.autoescape), "macros[\"getDefault\"]", [runtime.contextOrFrameLookup(context, frame, "scale"),runtime.contextOrFrameLookup(context, frame, "mapName"),runtime.contextOrFrameLookup(context, frame, "legendStyle")])))), env.opts.autoescape);
output += "\n                </code></pre>\n            </div>\n\n        </div>\n\n\n \n\n        ";
;
}
output += "\n\n    </div>\n</div>\n";
