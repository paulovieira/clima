...
output += "\n\n<div class=\"row\">\n    <div class=\"col-sm-10 col-sm-offset-1\" style=\"padding-top: 20px;\">\n        <p>Step 3: choose the attribute for the legend and the number of color classes</p>    \n\n        ";
output += "\n        <div class=\"row\" style=\"margin-top: 20px;\">\n            <div class=\"col-sm-5\">\n                Attribute (numeric columns from the attributes table of the selected shape):\n            </div>\n            <div class=\"col-sm-2\">\n                Number of classes:\n            </div>\n            <div class=\"col-sm-5\">\n                Color scheme (taken from <a target=\"_blank\" href=\"http://colorbrewer2.org/\">colorbrewer2.org</a>):\n            </div>\n        </div>\n\n\n        ";
...
var output = "";
try {
output += "<div class=\"row\">\n    <div class=\"col-sm-6 col-sm-offset-1\" style=\"padding-top: 20px;\">\n\n        <p>Step 2: choose shape (these are the shapes that have been added to the selected web map)</p>\n        <select class=\"form-control js-available-shapes\">\n            <option value=\"\">&mdash;</option>\n            ";
frame = frame.push();
var t_3 = runtime.contextOrFrameLookup(context, frame, "items");
if(t_3) {var t_2 = t_3.length;
for(var t_1=0; t_1 < t_3.length; t_1++) {
...
output += "</li>\n        </ul>\n\n        ";
if(runtime.contextOrFrameLookup(context, frame, "count") < runtime.contextOrFrameLookup(context, frame, "countGeometries")) {
output += "\n            \n            <div class=\"alert alert-danger\" role=\"alert\" style=\"padding-bottom: 0px;\">\n                <b>Warning:</b> the shape has ";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "countGeometries"), env.opts.autoescape);
output += " geometries, so there are ";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "countGeometries") - runtime.contextOrFrameLookup(context, frame, "count"), env.opts.autoescape);
...
output += " column with null values. The visualization of these entries should be trated manually (otherwise they will be invisible). Use the following condition in the cartoCSS editor:\n                <pre style=\"margin-top: 10px;\">\n#";
...
frame = frame.push();
var t_6 = runtime.contextOrFrameLookup(context, frame, "scale");
...
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((t_7),"valueClass", env.opts.autoescape)),0, env.opts.autoescape), env.opts.autoescape);
output += "\n\n                        ";
...
output += "\n                            &ndash; ";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((t_7),"valueClass", env.opts.autoescape)),1, env.opts.autoescape), env.opts.autoescape);
output += "\n                        ";
;
}
output += "\n\n                    </td>\n\n                    <td class=\"text-center\" style=\"background-color: ";
output += runtime.suppressValue(runtime.memberLookup((t_7),"colorHex", env.opts.autoescape), env.opts.autoescape);
...
output += "</a> map settings:</p>\n\n\n        <div class=\"row\">\n        \n            <div class=\"col-sm-6\">\n                <p style=\"margin-top: 15px; margin-bottom: 0px; \">CartoCSS </p>\n            </div>\n            <div class=\"col-sm-6\">\n                <button type=\"button\" class=\"pull-right btn btn-default js-select-code\" id=\"code-carto\">Select this block</button>        \n            </div>\n\n            <div class=\"col-sm-12\">\n                <pre style=\"margin-top: 4px;\"><code class=\"language-css\">\n                    ";
output += runtime.suppressValue(env.getFilter("trim").call(context, (lineno = 115, colno = 40, runtime.callWrap(runtime.memberLookup((t_1),"getCartoCode", env.opts.autoescape), "macros[\"getCartoCo\"]", [runtime.contextOrFrameLookup(context, frame, "scale"),runtime.contextOrFrameLookup(context, frame, "tableName"),runtime.contextOrFrameLookup(context, frame, "columnName"),runtime.contextOrFrameLookup(context, frame, "geometryTypePrimitive")]))), env.opts.autoescape);
...
output += runtime.suppressValue(env.getFilter("escape").call(context, env.getFilter("trim").call(context, (lineno = 150, colno = 48, runtime.callWrap(runtime.memberLookup((t_1),"getDefaultLegendHtml", env.opts.autoescape), "macros[\"getDefault\"]", [runtime.contextOrFrameLookup(context, frame, "scale"),runtime.contextOrFrameLookup(context, frame, "mapName"),runtime.contextOrFrameLookup(context, frame, "legendStyle")])))), env.opts.autoescape);
output += "\n                </code></pre>\n            </div>\n\n        </div>\n\n\n \n\n        ";
;
}
output += "\n\n    </div>\n</div>\n";
...
frame.set("loop.last", t_1 === t_2 - 1);
frame.set("loop.length", t_2);
output += "\n            <li class=\"list-group-item xmap-group\" data-id=\"x\" style=\"margin-top: 15px;\">\n\n                <b>";
output += runtime.suppressValue(runtime.memberLookup((t_4),"groupName", env.opts.autoescape), env.opts.autoescape);
output += "</b>\n                <ul class=\"list-group map-elems\" id=\"x-list\" style=\"margin-top: 5px;\">\n\n                \t";
frame = frame.push();
var t_7 = runtime.memberLookup((t_4),"mapElements", env.opts.autoescape);
if(t_7) {var t_6 = t_7.length;
for(var t_5=0; t_5 < t_7.length; t_5++) {
var t_8 = t_7[t_5];
frame.set("obj2", t_8);
...
try {
output += "<ul class=\"nav nav-tabs\">\n\n";
output += "\n\n    <li role=\"presentation\" class=\"active\">\n        <a href=\"#\" class=\"js-dashboard-sep\" data-tab-separator=\"maps-all\">All maps</a>\n    </li>\n\n    <li role=\"presentation\">\n        <a href=\"#\" class=\"js-dashboard-sep\" data-tab-separator=\"maps-new\">New map</a>\n    </li>\n\n    <li role=\"presentation\">\n        <a href=\"#\" class=\"js-dashboard-sep\" data-tab-separator=\"shapes-all\">All shapes</a>\n    </li>\n    \n    <li role=\"presentation\">\n        <a href=\"#\" class=\"js-dashboard-sep\" data-tab-separator=\"map-menu\">Map menu</a>\n    </li>\n\n    <li role=\"presentation\">\n        <a href=\"#\" class=\"js-dashboard-sep\" data-tab-separator=\"map-legends\">Legends</a>\n    </li>\n    ";
...
["scale", "tableName", "columnName", "geometryTypePrimitive"], 
[], 
function (l_scale, l_tableName, l_columnName, l_geometryTypePrimitive, kwargs) {
frame = frame.push();
kwargs = kwargs || {};
...
t_2 += "    \n\n        ";
var t_9;
t_9 = runtime.contextOrFrameLookup(context, frame, "cartoCode") + "#" + l_tableName + "[\"" + l_columnName + "\" = " + runtime.memberLookup((runtime.memberLookup((t_7),"valueClass", env.opts.autoescape)),0, env.opts.autoescape) + "]{" + "\n";
...
t_2 += "\n\n        ";
var t_10;
t_10 = runtime.contextOrFrameLookup(context, frame, "cartoCode") + "    marker-fill: " + runtime.memberLookup((t_7),"colorHex", env.opts.autoescape) + ";\n";
...
t_2 += "\n\n        ";
var t_11;
t_11 = runtime.contextOrFrameLookup(context, frame, "cartoCode") + "    line-color: " + runtime.memberLookup((t_7),"colorHex", env.opts.autoescape) + ";\n";
...
t_2 += "\n\n        ";
var t_12;
t_12 = runtime.contextOrFrameLookup(context, frame, "cartoCode") + "    polygon-fill: " + runtime.memberLookup((t_7),"colorHex", env.opts.autoescape) + ";\n";
...
t_2 += "\n\n    ";
var t_14;
t_14 = runtime.contextOrFrameLookup(context, frame, "cartoCode") + "}\n\n";
...
var t_16 = "";t_16 += "\n\n";
var t_17;
t_17 = "<div class='my-legend'>\n" + "<div class='legend-title'>" + l_mapName + "</div>\n" + "<div class='legend-scale'>\n\n" + "  <!--   BEGIN COLORS   |   BEGIN COLORS   |   BEGIN COLORS   -->\n" + "  <ul class='legend-labels'>\n";
frame.set("legendHtml", t_17, true);
if(!frame.parent) {
context.setVariable("legendHtml", t_17);
...
t_16 += "\n\n    ";
t_16 += "\n\n    ";
if(runtime.memberLookup((runtime.memberLookup((t_21),"valueClass", env.opts.autoescape)),0, env.opts.autoescape) != runtime.memberLookup((runtime.memberLookup((t_21),"valueClass", env.opts.autoescape)),1, env.opts.autoescape)) {
t_16 += "\n\n        ";
var t_22;
t_22 = runtime.contextOrFrameLookup(context, frame, "legendHtml") + "    <li><span style='background:" + runtime.memberLookup((t_21),"colorHex", env.opts.autoescape) + ";'></span>\n" + "            " + runtime.memberLookup((runtime.memberLookup((t_21),"valueClass", env.opts.autoescape)),0, env.opts.autoescape) + " &ndash; " + runtime.memberLookup((runtime.memberLookup((t_21),"valueClass", env.opts.autoescape)),1, env.opts.autoescape) + "\n" + "    </li>\n";
frame.set("legendHtml", t_22, true);
if(!frame.parent) {
context.setVariable("legendHtml", t_22);
context.addExport("legendHtml");
}
t_16 += "\n    \n\n    ";
;
...
t_16 += "    \n\n        ";
var t_23;
t_23 = runtime.contextOrFrameLookup(context, frame, "legendHtml") + "    <li><span style='background:" + runtime.memberLookup((t_21),"colorHex", env.opts.autoescape) + ";'></span>\n" + "            " + runtime.memberLookup((runtime.memberLookup((t_21),"valueClass", env.opts.autoescape)),0, env.opts.autoescape) + "\n" + "    </li>\n";
frame.set("legendHtml", t_23, true);
if(!frame.parent) {
context.setVariable("legendHtml", t_23);
context.addExport("legendHtml");
}
t_16 += "\n\n    ";
;
...
frame.set("legendCss", t_25, true);
if(!frame.parent) {
context.setVariable("legendCss", t_25);
...
frame.set("legendCss", t_26, true);
if(!frame.parent) {
context.setVariable("legendCss", t_26);
context.addExport("legendCss");
}
t_16 += "\n\n";
;
...
t_16 += "\n\n";
var t_27;
t_27 = runtime.contextOrFrameLookup(context, frame, "legendHtml") + runtime.contextOrFrameLookup(context, frame, "legendCss");
frame.set("legendHtml", t_27, true);
if(!frame.parent) {
context.setVariable("legendHtml", t_27);
context.addExport("legendHtml");
}
t_16 += "\n\n";
t_16 += "\n";
t_16 += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "legendHtml"), env.opts.autoescape);
t_16 += "\n\n";
;
frame = frame.pop();
...
context.setVariable("getDefaultLegendHtml", macro_t_15);
output += "\n\n\n";
cb(null, output);
;
} catch (e) {
