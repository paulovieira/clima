...
output += "\n        <div class=\"row\" style=\"margin-top: 20px;\">\n            <div class=\"col-sm-5\">\n                Attribute (numeric columns from the attributes table of the selected shape):\n            </div>\n            <div class=\"col-sm-2\">\n                Number of classes:\n            </div>\n            <div class=\"col-sm-5\">\n                Color scheme (taken from <a target=\"_blank\" href=\"http://colorbrewer2.org/\">colorbrewer2.org</a> - click to open in a new tab):\n            </div>\n        </div>\n\n\n        ";
...
var output = "";
try {
output += "<div class=\"row\">\n    <div class=\"col-sm-10 col-sm-offset-1\" style=\"padding-top: 20px;\">\n\n        <p>Step 2: choose shape (this are the shapes that have been added to the selected web map)</p>\n        <select class=\"form-control js-available-shapes\">\n            <option value=\"\">&mdash;</option>\n            ";
frame = frame.push();
var t_3 = runtime.contextOrFrameLookup(context, frame, "items");
if(t_3) {var t_2 = t_3.length;
for(var t_1=0; t_1 < t_3.length; t_1++) {
