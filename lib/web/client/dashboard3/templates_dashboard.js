...
frame = frame.pop();
output += "\n\n            </tbody>\n\n        </table>\n\n        <button type=\"button\" class=\"btn btn-default\" id=\"js-invert-colors\">Invert colors!</button>\n        <button type=\"button\" class=\"btn btn-default\" id=\"js-darken-colors\">Darken colors!</button>\n\n        ";
;
}
output += "\n\n    </div>\n</div>\n";
cb(null, output);
