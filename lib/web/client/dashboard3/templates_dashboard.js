...
frame = frame.push();
var t_7 = runtime.memberLookup((t_4),"shapeColumnsData", env.opts.autoescape);
...
var output = "";
try {
output += "<div class=\"row\" style=\"margin-top: 20px;\">\n    <div class=\"col-sm-12\">\n        Step 3: choose the attribute for the legend and the number of color classes\n    </div>\n</div>\n\n<div class=\"row\" style=\"margin-top: 20px;\">\n    <div class=\"col-sm-4\">\n        Choose attribute (numeric columns from the attributes table of the selected shape):\n    </div>\n    <div class=\"col-sm-4\">\n        Number of classes:\n    </div>\n    <div class=\"col-sm-4\">\n        Color scheme (taken from <a href=\"http://colorbrewer2.org/\">colorbrewer2.org</a>):\n    </div>\n</div>\n\n<div class=\"row\" style=\"margin-top: 5px;\">\n    <div class=\"col-sm-4\">\n\n\n        <select class=\"form-control js-available-attributes\">\n            <option value=\"\">---</option>\n\n            ";
frame = frame.push();
...
frame = frame.pop();
output += "\n    </select>\n   \n    </div>\n</div>\n\n<div class=\"row\">\n    <div class=\"col-sm-10 col-sm-offset-1\" style=\"padding-top: 20px;\" id=\"choose-shape-region\">\n   \n    </div>\n</div>\n\n";
cb(null, output);
;
} catch (e) {
  cb(runtime.handleError(e, lineno, colno));
...
var output = "";
try {
output += "Step 2: choose shape (this are the shapes that have been added to the selected web map)\n\n<select class=\"form-control js-available-shapes\">\n    <option value=\"\">---</option>\n    ";
frame = frame.push();
var t_3 = runtime.contextOrFrameLookup(context, frame, "items");
if(t_3) {var t_2 = t_3.length;
for(var t_1=0; t_1 < t_3.length; t_1++) {
...
var output = "";
try {
output += "\n<div class=\"row\">\n    <div class=\"col-sm-8 col-sm-offset-2\" style=\"border-style:none solid none; border-width: 1px; border-color: rgb(231, 231, 231);   padding: 20px 20px; margin-bottom: 50px;\">\n\n        <ul style=\"margin-bottom: 10px;\">\n            <li><b>Minimum:</b> ";
...
frame = frame.push();
var t_3 = runtime.contextOrFrameLookup(context, frame, "scale");
if(t_3) {var t_2 = t_3.length;
for(var t_1=0; t_1 < t_3.length; t_1++) {
var t_4 = t_3[t_1];
frame.set("class", t_4);
...
output += runtime.suppressValue(env.getFilter("first").call(context, runtime.memberLookup((t_4),"valueClass", env.opts.autoescape)), env.opts.autoescape);
output += "\n                        ";
if(runtime.memberLookup((runtime.memberLookup((t_4),"valueClass", env.opts.autoescape)),"length", env.opts.autoescape) > 1) {
output += "\n                            &ndash; ";
output += runtime.suppressValue(env.getFilter("last").call(context, runtime.memberLookup((t_4),"valueClass", env.opts.autoescape)), env.opts.autoescape);
output += "\n                        ";
;
}
output += "\n                    </td>\n\n                    <td class=\"text-center\" style=\"background-color: ";
output += runtime.suppressValue(runtime.memberLookup((t_4),"colorHex", env.opts.autoescape), env.opts.autoescape);
...
output += ">\n                Invert color ordering\n          </label>\n        </div>\n\n        <div class=\"checkbox\">\n          <label>\n            <input type=\"checkbox\" value=\"\" id=\"js-light-correction\" ";
output += runtime.suppressValue((runtime.contextOrFrameLookup(context, frame, "lightCorrection")?"checked":""), env.opts.autoescape);
output += ">\n                Automatic lightness correction \n          </label>\n        </div>\n\n        <button type=\"button\" class=\"btn btn-default\" id=\"js-darken-colors\">Darken!</button>\n        <button type=\"button\" class=\"btn btn-default\" id=\"js-brighten-colors\">Brigthen!</button>\n        <button type=\"button\" class=\"btn btn-default\" id=\"js-saturate-colors\">Saturate!</button>\n        <button type=\"button\" class=\"btn btn-default\" id=\"js-desaturate-colors\">Desaturate!</button>\n\n        ";
;
}
output += "\n\n    </div>\n</div>\n";
cb(null, output);
...
var output = "";
try {
output += "<p>Sorry. This shape doesn't have any numeric attributes! </p>\n";
cb(null, output);
;
} catch (e) {
  cb(runtime.handleError(e, lineno, colno));
...
var output = "";
try {
output += "<p>This map doesn't have any shapes yet! </p>\n<p>Use the \"Layers\" menu in the TileMill interface (bottom left corner).</p>";
cb(null, output);
;
} catch (e) {
  cb(runtime.handleError(e, lineno, colno));
...
output += "\" disabled>\n                </div>\n            </div>\n        </div>\n\n        <div class=\"form-group\">\n            <label>Owner</label>\n            <input type=\"text\" class=\"form-control\" value=\"";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "ownerData")),"first_name", env.opts.autoescape), env.opts.autoescape);
output += " ";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "ownerData")),"last_name", env.opts.autoescape), env.opts.autoescape);
