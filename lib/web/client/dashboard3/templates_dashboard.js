...
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["maps/templates/legends-attributes.html"] = (function() {function root(env, context, frame, runtime, cb) {
var lineno = null;
var colno = null;
var output = "";
try {
output += "Step 3: choose attribute (these are the numeric columns from the attributes table of the selected shape)\n\n<select class=\"form-control js-available-attributes\">\n    <option value=\"\">---</option>\n\n    ";
frame = frame.push();
...
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["maps/templates/legends-shapes.html"] = (function() {function root(env, context, frame, runtime, cb) {
var lineno = null;
var colno = null;
var output = "";
try {
...
frame = frame.pop();
output += "\n</select>\n\n<div id=\"available-attributes-region\"></div>\n\n<div class=\"row\">\n    <div class=\"col-sm-10 col-sm-offset-1\" style=\"padding-top: 20px;\" id=\"available-attributes-regionxxx\">\n   \n    </div>\n</div>";
cb(null, output);
;
} catch (e) {
  cb(runtime.handleError(e, lineno, colno));
...
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["maps/templates/legends.html"] = (function() {function root(env, context, frame, runtime, cb) {
var lineno = null;
var colno = null;
var output = "";
try {
...
frame = frame.pop();
output += "\n    </select>\n   \n    </div>\n</div>\n\n<div class=\"row\">\n    <div class=\"col-sm-10 col-sm-offset-1\" style=\"padding-top: 20px;\" id=\"available-shapes-region\">\n   \n    </div>\n</div>\n\n";
cb(null, output);
;
} catch (e) {
  cb(runtime.handleError(e, lineno, colno));
