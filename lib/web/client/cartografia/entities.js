...
_.each(Clima.mapsMenu, function(groupObj){
    ...
    _.each(groupObj.maps, function(mapObj){
        ...
        if(tileJson.id === "here-satellite-day"){
            debugger;
            var urlTemplate = 'http://1.aerial.maps.cit.api.here.com/maptile/2.1/maptile/newest/{variant}/{z}/{x}/{y}/256/png8?app_id=Y8m9dK2brESDPGJPdrvs&app_code=Y8m9dK2brESDPGJPdrvs&app_code=dq2MYIvjAotR8tHvY8Q_Dg';
