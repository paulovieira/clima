...
internals.clientAppRelDir = "lib/cartografia2/app";

internals.build = function(commands){

    var webpackConfig = Path.join(Config.get("rootDir"), "lib/cartografia2/webpack.config.js");
    var gruntfile = Path.join(Config.get("rootDir"), "lib/cartografia2/grunt.config.js");
    ...
    server.route({
        ...
        config: {
            handler: function(request, reply) {
                ...
                return reply.view(Path.join(__dirname, "templates/cartografia2.html"), { ctx: context });
            },
            //auth: internals.auth,
            pre: [
            ],
