...
// TODO: use this again
        ...
        if(!request.auth.credentials.canEditMaps){
            return reply(Boom.forbidden("To accomplish this action you must have the 'edit maps' permission"));
        }
...
internals.delete = {
    ...
    handler: function(request, reply) {
        ...
        if(!request.auth.credentials.canDeleteMaps){
            return reply(Boom.forbidden("To accomplish this action you must have the 'delete maps' permission"));
        }
...
echo '{ "name": "Anomalia da temperatura: A2, 2070-2099 (animação)", "description": "Anomalia da temperatura (animação)", "hasPlayButton": true, "autoPlay": false, "sequence": [{"mapId": "anomalia-da-temperatura-inverno-a2-2070-2099", "seqName": "Inverno"}, {"mapId": "anomalia-da-temperatura-verao-a2-2070-2099", "seqName": "Verão"}, {"mapId": "anomalia-da-temperatura-primavera-a2-2070-2099", "seqName": "Primavera"}, {"mapId": "anomalia-da-temperatura-outono-a2-2070-2099", "seqName": "Outono"}] }' | http -v POST http://clima-madeira.pt/api/v1/maps
