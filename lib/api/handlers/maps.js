...
echo '{ "name": "teste seq 1", "description": "teste seq 1 - desc", "hasPlayButton": true, "autoPlay": false, "sequence": [{"mapId": "mapa-base-freguesias", "seqName": "seq name 1"}, {"mapId": "new-map", "seqName": "seq name 2"}] }' | http -v POST http://clima.dev/api/v1/maps
