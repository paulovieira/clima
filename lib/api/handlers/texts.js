...
internals.create = {
    ...
    handler: function(request, reply) {
        ...
        if(!request.auth.credentials.canEditTexts){
            return reply(Boom.forbidden("To accomplish this action you must have the 'edit texts' permission"));
        }
...
internals.update = {
    ...
    pre: [
        [Utils.abortIfNotAuthenticated],
        [Pre.readAllUsersGroups, Utils.extractTags]
    ],
...
internals.delete = {
    ...
    handler: function(request, reply) {
        ...
        if(!request.auth.credentials.canDeleteTexts){
            return reply(Boom.forbidden("To accomplish this action you must have the 'delete texts' permission"));
        }
