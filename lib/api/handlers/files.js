...
internals.create = {
    ...
    handler: function(request, reply) {
        ...
        if(!request.auth.credentials.canEditFiles){
            return reply(Boom.forbidden("To accomplish this action you must have the 'edit files' permission"));
        }
...
//        payload: internals.validatePayloadForCreate
    ...
    payload: {
        output: "stream",
        parse: true,
        maxBytes: 1048576*250  // 250 megabytes - TODO get this setting from the default options
    },
...
internals.delete = {
    ...
    handler: function(request, reply) {
        ...
        if(!request.auth.credentials.canDeleteFiles){
            return reply(Boom.forbidden("To accomplish this action you must have the 'delete files' permission"));
        }
