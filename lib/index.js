...
var internals = {
	...
	api: require("./api"),
	web: require("./web"),
    defaultTexts: require("./web/read-default-texts")
};
...
internals.init = function(){
	...
	server.register(internals.externalPlugins, function(err) {
		...
		server.register([internals.api, internals.web, internals.defaultTexts], function(err){
    ...
    //     console.log("server.app.defaultTexts[0]: ", _.findWhere(server.app.defaultTexts, {id: 0}))
    //     console.log("server.app.defaultTexts[107]: ", _.findWhere(server.app.defaultTexts, {id: 107}) )
    // });
